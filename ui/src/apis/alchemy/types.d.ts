...
/** @public */
declare type TokenBalance = TokenBalanceSuccess | TokenBalanceFailure;
/** @public */
 ...
 * @public
 */
interface AssetTransfersWithMetadataParams extends AssetTransfersParams {
    withMetadata: true;
}
/**
 ...
 * @public
 */
declare enum AssetTransfersCategory {
    /**
 ...
 */
declare enum GetTransfersForOwnerTransferType {
    'TO' = "TO",
    'FROM' = "FROM"
}
/**
 ...
 * @public
 */
declare type TransactionReceiptsParams = TransactionReceiptsBlockNumber | TransactionReceiptsBlockHash;
/**
 ...
 */
declare enum AlchemySubscription {
 ...
 */
declare type AlchemyMinedTransactionsAddress = RequireAtLeastOne<{
    to?: string;
    from?: string;
}>;
/**
 ...
 * @public
 */
declare type AlchemyEventType = EventType | AlchemyEventFilter;
/**
 * This type represents the Alchemy's Subscription API endpoints as event
 * filters compatible with other ethers events.
 */
declare type AlchemyEventFilter = AlchemyMinedTransactionsEventFilter | AlchemyPendingTransactionsEventFilter;
 ...
 */
declare enum SimulateAssetType {
    /**
 ...
 */
declare enum SimulateChangeType {
    /**
 ...
 */
declare enum DecodingAuthority {
    ETHERSCAN = "ETHERSCAN"
}
 ...
 */
declare type NftWebhookUpdate = WebhookStatusUpdate | RequireAtLeastOne<WebhookNftFilterUpdate>;
/**
 * Params object when calling {@link NotifyNamespace.updateWebhook} to update a
 * {@link NftMetadataUpdateWebhook}.
 */
declare type NftMetadataWebhookUpdate = WebhookStatusUpdate | RequireAtLeastOne<WebhookNftMetadataFilterUpdate>;
/**
 * Params object when calling {@link NotifyNamespace.updateWebhook} to update a
 * {@link CustomGraphqlWebhook}.
 */
declare type CustomGraphqlWebhookUpdate = WebhookStatusUpdate;
/**
 * Params object when calling {@link NotifyNamespace.updateWebhook} to update a
 * {@link AddressActivityWebhook}.
 */
declare type AddressWebhookUpdate = WebhookStatusUpdate | RequireAtLeastOne<WebhookAddressUpdate> | WebhookAddressOverride;
/**
 ...
 */
declare type BlockIdentifier = string | CommitmentLevel;
/**
 * The type of tracer to use when running debug methods in the
 * {@link DebugNamespace}.
 */
declare enum DebugTracerType {
 ...
 */
declare type DebugPrestateTrace = Record<string, DebugPrestate>;
/** The */
